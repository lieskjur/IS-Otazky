...
% \begin{multicols}{2}
	...
	\end{itemize}
	The basic algorithm of the identification procedure is as
follows:
\begin{enumerate}
...
\end{enumerate}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=.8\linewidth]{figs/lolimot_narx.png}
	\end{figure}	
	\pagebreak
	Identifikace pak probíhá metodou nejmenších čtverců dle schématu
	\begin{figure}[h!]
		\centering
		\includegraphics[width=.8\linewidth]{figs/is_narx-id.pdf}
	\end{figure}
	...
	Fenomenologicky například inentifikujeme tření (např. Lu Gre model)
	\begin{figure}[h!]
		\centering
